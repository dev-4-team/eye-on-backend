...
public enum ProtestErrorCode implements BaseErrorCode {
    ...
    PROTEST_CHEER_COUNT_NOT_FOUND(NOT_FOUND, "PROTEST_400_2", "해당 id의 시위 응원 정보를 조회할 수 없습니다"),
    PROTEST_CACHE_NOT_FOUND(NOT_FOUND, "PROTEST_400_3", "Cache에서 해당 id의 시위 정보를 조회할 수 없습니다"),
