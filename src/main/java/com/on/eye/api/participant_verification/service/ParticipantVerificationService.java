...
public class ParticipantVerificationService {
    ...
    public void participateVerify(Protest protest, Coordinate userCoordinate) {
        ...
        checkAbnormalMovementPattern(anonymousUserId, userCoordinate);

        saveVerification(protest, anonymousUserId);
    }

    private void checkAbnormalMovementPattern(String anonymousUserId, Coordinate userCoordinate) {
    ...
    private void saveVerification(Protest protest, String anonymousUserId) {
